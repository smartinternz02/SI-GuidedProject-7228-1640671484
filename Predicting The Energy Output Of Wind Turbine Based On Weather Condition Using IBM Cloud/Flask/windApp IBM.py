...
API_KEY = "dwpVEqaS_JQuWwAqrjH0EvajblrENp8J0Xdi2787rfsV"
...
def y_predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/57c13e83-a221-49a7-aac8-eecbf99278e5/predictions?version=2022-01-21', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
